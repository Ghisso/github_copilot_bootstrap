...
- GitHub Copilot has 9 `.github/agents/*.agent.md` files.
- The generated output has 9 canonical `.claude/agents/*.md` files.
- OpenAI Codex has 9 `.codex/agents/*.toml` files.
