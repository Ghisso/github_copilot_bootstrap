...
1. ✅ Integration gate step (N.0) executed and documented in `.codex/quality_reports/` or `docs/INTEGRATION_GATE_RESULTS.md`
...
- `.agents/skills/plan-decomposition/SKILL.md` — Structuring multi-phase plans where gates are needed
- `.agents/skills/iterative-plan-review/SKILL.md` — Design review gates that catch contract uncertainty early
- `.agents/skills/text-to-sql-safety/SKILL.md` — Similar gated defense-in-depth for unknown SQL query shapes
