...
- Copy `.codex/` directory (instructions, agents, skills, plans, session_logs, MEMORY.md)
- Copy `pyproject.toml`, `.gitignore`, `.env.example`
- Copy `AGENTS.md` to the new project's root
...
```bash
git add .codex/ pyproject.toml .gitignore .env.example
