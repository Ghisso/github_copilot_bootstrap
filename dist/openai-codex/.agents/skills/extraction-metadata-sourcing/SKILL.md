...
- `.agents/skills/integration-gate-spike/SKILL.md` — How to validate external metadata API contracts
- `.agents/skills/csv-driven-integration-tests/SKILL.md` — Integration test datasets with field source tracking
- `.agents/skills/testing-patterns/SKILL.md` — Mocking external metadata providers in tests
