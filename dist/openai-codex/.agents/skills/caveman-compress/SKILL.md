...
1. Run the detector first:
   ...
   ```bash
   python .agents/skills/caveman-compress/scripts/detect.py <filepath>
   ```
...
8. Validate the result:
   ...
   ```bash
   python .agents/skills/caveman-compress/scripts/validate.py <original-backup> <compressed-file>
   ```
...
```text
/caveman:compress .codex/session_logs/2026-04-09_caveman-integration.md
```
