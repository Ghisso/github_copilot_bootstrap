...
into a single score against the rubric in AGENTS.mdQuality Gates & Testing Protocol.

Usage:
    python .codex/scripts/quality_score.py src/
    python .codex/scripts/quality_score.py src/retrieval/query_runner.py
    python .codex/scripts/quality_score.py src/ --json
    python .codex/scripts/quality_score.py src/ --skip-tests
"""
...
# ---------------------------------------------------------------------------
# Scoring weights (from Quality Gates & Testing Protocol rubric)
# ---------------------------------------------------------------------------
