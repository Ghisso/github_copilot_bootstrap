...
Custom agents are rendered as Claude Code project subagents in `.claude/agents/`. Copilot model pins are intentionally omitted; review helpers use Claude-native primary/adversarial passes.
