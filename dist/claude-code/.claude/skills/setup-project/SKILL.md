...
- Copy `.claude/` directory (instructions, agents, skills, plans, session_logs, MEMORY.md)
- Copy `pyproject.toml`, `.gitignore`, `.env.example`
- Copy `CLAUDE.md` to the new project's root

## Step 3: Configure Project
```bash
# Update pyproject.toml with project name
# Update CLAUDE.md Project State section
...
```bash
git add .claude/ pyproject.toml .gitignore .env.example
