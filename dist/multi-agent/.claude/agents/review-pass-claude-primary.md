---
name: review-pass-claude-primary
description: "Hidden helper agent that runs a strict review pass using Claude target-native primary review and returns findings in a normalized structure for downstream synthesis."
