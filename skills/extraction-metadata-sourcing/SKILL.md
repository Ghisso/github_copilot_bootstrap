...
See `references/case-study.md` for a worked classification table from a UN
Security Council resolution extraction project.
...
See `references/case-study.md` for a full worked case study (UN Security
Council resolution extraction, 2798 documents) applying this method
end-to-end, with the source-coverage numbers it produced.
