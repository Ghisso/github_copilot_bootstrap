...
into a single score against the rubric in .github/instructions/quality-and-testing.instructions.md.

Usage:
    python .github/scripts/quality_score.py src/
    python .github/scripts/quality_score.py src/retrieval/query_runner.py
    python .github/scripts/quality_score.py src/ --json
    python .github/scripts/quality_score.py src/ --skip-tests
"""
