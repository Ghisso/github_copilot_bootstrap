...
This repository is a reusable multi-agent bootstrap. Preserve the pre-flight -> branch -> plan when needed -> implement -> verify -> review -> closeout -> commit -> push workflow and keep hook guardrails intact.
