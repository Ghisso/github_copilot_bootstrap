...
phase_index: 1
status: complete
closeout_session_log: .claude/session_logs/2026-09-25_sidecar-phase-A-provider-contract.md
---
...
- [x] **1. Re-check the documented starting point.**
  - **Owner:** `coder`
...
- [x] **3. Run each client against the fixture.**
